...
// x inicial e y inicial do robo
    ...
    let x = parseInt(prompt("Digite o valor do robo em X (0 a 9)"));
    let y = parseInt(prompt("Digite o valor do robo em Y (0 a 6)"));
...
// componente y da aceleracao do robo pelo tempo
var ay_robo = {
    x: vetorTempo,
    y: aceleracaoRoboI,
    mode: 'lines+markers',
